...
LeshaCat: "I decided a soft fork would be well suited. But if you would like to contribute, please consider looking at the [original project](https://github.com/foxer666/node-open-mining-portal) and [parent project](https://github.com/1301313Y/BootNOMP) first, as these guys are the ones who helped get this NOMP rebirthing process started."
